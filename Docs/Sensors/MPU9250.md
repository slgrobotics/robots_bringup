...
**Note:** Magnetometer calibration is NOT OPTIONAL.
Run [calibration script](https://github.com/slgrobotics/mpu9250/blob/main/tests/calibrate_mag.py) and copy/paste its output in your launch file.

https://www.ngdc.noaa.gov/geomag/calculators/magcalc.shtml?#igrfwmm - magnetic field by location (microTesla)
